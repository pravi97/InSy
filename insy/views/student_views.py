...
class StudentListView(ListView):
    model = Student
    template_name = "insy/student_list.html"
    paginate_by = 20
...
class StudentDetailView(DetailView):
    model = Student
    template_name = "insy/student_detail.html"
...
class StudentCreateView(CreateView):
    ...
    template_name = "insy/student_create.html"
...
class StudentUpdateView(UpdateView):
    ...
    form_class = StudentForm
    # fields = ['user', 'department', 'semester', 'date_of_registration', 'name', 'name_of_parent', 'address', 'Academic_History', 'Whether_eligible_for_registration', 'Hosteler_or_dayscholar', 'name_of_hostel']
    template_name = "insy/student_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class StudentDeleteView(DeleteView):
    model = Student
    template_name = "insy/student_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "student"
